...
import CategoryFormProvider from '../forms/category/CategoryFormProvider'
import CategoryForm from '../forms/category/CategoryForm'
import { categoryFormContext } from '../forms/category/category-form-context'
import { nextFrame } from '~/utils/common'
import { useSafeAreaInsets } from 'react-native-safe-area-context'

const CategoryFormSheet = ({}, ref) => {
  ...
  return (
    <BottomSheetModal
      ...
      onDismiss={() => setParams()}
    >
      <CategoryFormProvider params={params} onCloseRequest={close}>
        ...
        >
          ...
          />
          <FormActionButtons context={categoryFormContext} />
          <View
            style={{
              position: 'absolute',
              left: 0,
...
export default forwardRef(CategoryFormSheet)
